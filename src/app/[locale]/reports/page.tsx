...
export default function ReportsPage() {
  const { history, userTier } = useAppStore();
    ...
    <div className="flex flex-col w-full h-full overflow-y-auto bg-black p-4 md:p-8">
      <div className="max-w-4xl w-full mx-auto pb-20">
        ...
        <div className="flex items-center gap-4 mb-8">
          ...
          <h1 className="text-3xl font-bold text-white tracking-tight font-display">My Reports</h1>
        </div>
        ...
        {userTier !== 'Pro' ? (
          <motion.div 
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            className="w-full bg-[#111111] border border-white/5 rounded-2xl p-8 md:p-12 text-center shadow-2xl relative overflow-hidden"
          >
            <div className="mx-auto w-16 h-16 bg-purple-500/10 text-purple-400 flex items-center justify-center rounded-2xl mb-6 shadow-xl shadow-purple-900/20">
              <Lock size={32} />
            </div>
            <h2 className="text-2xl font-bold text-white mb-3 font-display">Security Analytics Locked</h2>
            <p className="text-white/60 max-w-lg mx-auto mb-8 leading-relaxed">
              Unlock the full power of ForgeGuard with a Pro account. Monitor your complete scan history, receive automated targeted attack alerts, and view advanced metrics.
            </p>
            <button className="bg-purple-500 hover:bg-purple-600 text-white font-bold py-3 px-8 rounded-xl transition-colors shadow-lg shadow-purple-900/30">
